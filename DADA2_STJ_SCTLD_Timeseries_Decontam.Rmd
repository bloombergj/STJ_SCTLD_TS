...
meta <- read.csv("meta_table.csv", header = TRUE)
meta <- meta[1:164, 1:16]

taxonomy <- read.delim("~/Documents/WHOI/Projects/STJ_SCTLD_TimeseriesExperiment/Analysis_Code/taxonomy_STJSCTLD_final.txt")

ASVsequence <- read.delim("~/Documents/WHOI/Projects/STJ_SCTLD_TimeseriesExperiment/Analysis_Code/ASVsequences_STJSCTLD_final.txt")
...
save(contam, file="~/Documents/WHOI/Projects/STJ_SCTLD_TimeseriesExperiment/Analysis_Code/contam.RData")
