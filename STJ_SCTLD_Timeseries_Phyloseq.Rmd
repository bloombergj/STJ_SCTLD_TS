...
perm <- how(
  ...
  within = Within(within = SW_ALL_metadata$Date)  # Keep the time series structure within each plot
)
...
#ok but these models do not account for the nested/nonidenpendent nature of the data, but it is useful for data exploration purposes only.
...
geom_point(data = df2, aes(x=Date_forPlot, y=distance, color=Healthy_Diseased_Recovered), size=5) +
...
#dist.tab_SW_FB_nodead <- subset(dist.tab_SW_FB, Healthy_Diseased_Recovered != "Dead")
dist.tab_epidemic <- subset(dist.tab_SW_FB, Disease_Phase == "Epidemic")
dist.tab_epidemic$Tag <- as.character(dist.tab_epidemic$Tag)
str(dist.tab_epidemic$Tag)

dist.tab_endemic <- subset(dist.tab_SW_FB, Disease_Phase == "Endemic")
dist.tab_endemic$Tag <- as.character(dist.tab_endemic$Tag)
...
model <- lmerTest::lmer(distance ~ Healthy_Diseased_Recovered + (1 | Tag), data = dist.tab_epidemic)
summary(model)
#Fixed effects:
#                                     Estimate Std. Error       df t value Pr(>|t|)    
# (Intercept)                          0.20072    0.06354  5.87252   3.159 0.020169 *  
# Healthy_Diseased_RecoveredDiseased   0.33892    0.07736 23.93528   4.381 0.000201 ***
# Healthy_Diseased_RecoveredRecovered  0.09478    0.08850 14.17204   1.071 0.302098    
# Healthy_Diseased_RecoveredDead      -0.02675    0.12758 23.59453  -0.210 0.835748 
print(anova(model))
    # Type III Analysis of Variance Table with Satterthwaite's method
    #                             Sum Sq Mean Sq NumDF  DenDF F value   Pr(>F)   
    # Healthy_Diseased_Recovered 0.52877 0.17626     3 18.162  7.8298 0.001469 **
    # ---
    # Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
ls_means(model, pairwise=TRUE)
      # Healthy_Diseased_RecoveredHealthy - Healthy_Diseased_RecoveredDiseased   -0.179239 0.0002014 ***
      # Healthy_Diseased_RecoveredHealthy - Healthy_Diseased_RecoveredRecovered   0.094820 0.3020978    
      # Healthy_Diseased_RecoveredHealthy - Healthy_Diseased_RecoveredDead        0.290301 0.8357483    
      # Healthy_Diseased_RecoveredDiseased - Healthy_Diseased_RecoveredRecovered  0.414301 0.0068973 ** 
      # Healthy_Diseased_RecoveredDiseased - Healthy_Diseased_RecoveredDead       0.627920 0.0083240 ** 
      # Healthy_Diseased_RecoveredRecovered - Healthy_Diseased_RecoveredDead      0.407103 0.3863642    
      # ---


# ------------------
# 
##### This stuff here doesn't account for pseudoreplication
# anova_result <- aov(distance ~ Healthy_Diseased_Recovered, data = dist.tab_epidemic)
# summary(anova_result)
#       #                            Df Sum Sq Mean Sq F value  Pr(>F)   
#       # Healthy_Diseased_Recovered  3 0.5687 0.18956    7.25 0.00126 **
#       # Residuals                  24 0.6275 0.02615                   
# tukey_result <- TukeyHSD(anova_result)
# print(tukey_result)
#       #                          diff         lwr         upr     p adj
#       # Diseased-Dead       0.3200285 -0.02867786  0.66873483 0.0801378
#       # Healthy-Dead        0.0101110 -0.33859534  0.35881735 0.9998110
#       # Recovered-Dead      0.0248712 -0.32777545  0.37751786 0.9973163
#       # Healthy-Diseased   -0.3099175 -0.52019532 -0.09963964 0.0023563 ***
#       # Recovered-Diseased -0.2951573 -0.51190672 -0.07840785 0.0050243 ***
#       # Recovered-Healthy   0.0147602 -0.20198923  0.23150964 0.9975816
...
model <- lmerTest::lmer(distance ~ Healthy_Diseased_Recovered + (1 | Tag), data = dist.tab_endemic)
summary(model)
#                                     Estimate Std. Error       df t value Pr(>|t|)    
# (Intercept)                          0.30390    0.02602 10.00000  11.679 3.77e-07 ***
# Healthy_Diseased_RecoveredRecovered -0.05390    0.03187 10.00000  -1.691    0.122    
# Healthy_Diseased_RecoveredDead       0.00122    0.05818 10.00000   0.021    0.984   
print(anova(model))
# Type III Analysis of Variance Table with Satterthwaite's method
#                               Sum Sq   Mean Sq NumDF DenDF F value Pr(>F)
# Healthy_Diseased_Recovered 0.0090203 0.0045102     2    10  1.6653 0.2375

# ------------------
#
##### This stuff here doesn't account for pseudoreplication
# anova_result <- aov(distance ~ Healthy_Diseased_Recovered, data = dist.tab_endemic)
# summary(anova_result)
#       #                            Df  Sum Sq  Mean Sq F value Pr(>F)
#       # Healthy_Diseased_Recovered  2 0.00902 0.004510   1.665  0.238
#       # Residuals                  10 0.02708 0.002708  
ls_means(model, pairwise=TRUE)
#                                                                               upper Pr(>|t|)
# Healthy_Diseased_RecoveredDiseased - Healthy_Diseased_RecoveredRecovered  0.1249043   0.1217
# Healthy_Diseased_RecoveredDiseased - Healthy_Diseased_RecoveredDead       0.1284213   0.9837
# Healthy_Diseased_RecoveredRecovered - Healthy_Diseased_RecoveredDead      0.0678719   0.3416
...
rm(list = setdiff(ls(), c("ps.decontam.filt", "ps.seawater.Fishbay", "ps.Seawater.Coralbay")))

asv_abundance <- as.data.frame(as.matrix(otu_table(ps.seawater.Fishbay)))
 #46 obs of 7023 variables
meta_forBubble <- sample_data(ps.seawater.Fishbay)

ASVofInterst <- c("ASV1", "ASV45", "ASV67", "ASV79", "ASV84")
...
colNeeded <- c("ASV1", "ASV45", "ASV67", "ASV79", "ASV84", "Sample_names", "Site", "Tag", "Date", "Sample_Type", "Healthy_Diseased_Recovered")
...
ggplot(combo_data,
       aes(x = Date, 
          ...
          color = Healthy_Diseased_Recovered)) +
  geom_point()+
  labs(x = "Date", y = "Colony Tag", title = "ASV 84 Relative Abundance") +
   theme(axis.text.x = element_text(angle = 90, hjust = 1)) 
...
ggplot(combo_data_forplotting, aes(x = Date, y = RelativeAbundance, color = ASV, group = ASV)) +
  ...
  scale_color_manual(breaks=c("ASV1", "ASV45", "ASV67", "ASV79", "ASV84"), 
                       values = c("#009E73", "#E69F00", "#D55E00", "#0072B2", "#CC79A7")) 
...
# Make factors
# ps.Counts.Seawater.Fishbay is the phyloseq object with the top 200 taxa across treatments 1 and 3
...
#ps200_HorD <- subset_samples(ps.Counts.Seawater.Fishbay, Healthy_or_Diseased %in% c("Healthy", "Diseased"))


# Corncob: Differential abundance test 
set.seed(1)
DA.seawater.epidemic <- differentialTest(formula = ~ Healthy_or_Diseased + Date, 
                             phi.formula = ~ Healthy_or_Diseased + Date,
                             formula_null = ~ Date,
                             phi.formula_null = ~ Healthy_or_Diseased + Date,
                             test = "Wald", boot = FALSE,
                             data = ps.Counts.Seawater.Fishbay,
                             fdr_cutoff = 0.1)

DA.seawater.epidemic$significant_taxa
length(DA.seawater.epidemic$significant_taxa) #13! that's a super reasonable number! Woohoo!
#"ASV14"   "ASV63"   "ASV113"  "ASV121"  "ASV169"  "ASV172"  "ASV176"  "ASV207"  "ASV236"  "ASV418"  "ASV905"  "ASV1227" "ASV1619"
...
#   [1] "ASV1"    "ASV2"    "ASV4"    "ASV5"    "ASV6"    "ASV7"    "ASV8"    "ASV9"    "ASV10"   "ASV12"   "ASV13"   "ASV14"   "ASV17"   "ASV18"   "ASV19"   "ASV23"  
#  [17] "ASV24"   "ASV25"   "ASV26"   "ASV27"   "ASV28"   "ASV31"   "ASV32"   "ASV33"   "ASV34"   "ASV35"   "ASV36"   "ASV39"   "ASV40"   "ASV44"   "ASV46"   "ASV49"  
#  [33] "ASV53"   "ASV57"   "ASV62"   "ASV63"   "ASV64"   "ASV65"   "ASV71"   "ASV72"   "ASV76"   "ASV80"   "ASV82"   "ASV83"   "ASV85"   "ASV88"   "ASV90"   "ASV92"  
#  [49] "ASV93"   "ASV95"   "ASV101"  "ASV108"  "ASV113"  "ASV114"  "ASV115"  "ASV116"  "ASV120"  "ASV121"  "ASV124"  "ASV126"  "ASV129"  "ASV141"  "ASV144"  "ASV149" 
#  [65] "ASV150"  "ASV154"  "ASV157"  "ASV162"  "ASV163"  "ASV164"  "ASV168"  "ASV169"  "ASV172"  "ASV175"  "ASV176"  "ASV178"  "ASV180"  "ASV188"  "ASV190"  "ASV194" 
#  [81] "ASV205"  "ASV207"  "ASV212"  "ASV218"  "ASV225"  "ASV228"  "ASV231"  "ASV236"  "ASV237"  "ASV249"  "ASV252"  "ASV258"  "ASV260"  "ASV261"  "ASV262"  "ASV279" 
#  [97] "ASV283"  "ASV295"  "ASV305"  "ASV315"  "ASV322"  "ASV325"  "ASV328"  "ASV330"  "ASV333"  "ASV339"  "ASV352"  "ASV353"  "ASV362"  "ASV372"  "ASV374"  "ASV379" 
# [113] "ASV388"  "ASV413"  "ASV418"  "ASV420"  "ASV427"  "ASV437"  "ASV449"  "ASV453"  "ASV460"  "ASV510"  "ASV523"  "ASV531"  "ASV533"  "ASV549"  "ASV564"  "ASV598" 
# [129] "ASV713"  "ASV739"  "ASV747"  "ASV802"  "ASV840"  "ASV902"  "ASV905"  "ASV917"  "ASV1119" "ASV1281" "ASV1509" "ASV1706" "ASV3437"
plot(DA.seawater.epidemic) # a bunch positive and negative

# Corncob: Differential abundance test 
set.seed(1)
DA.seawater.epidemic_nodate <- differentialTest(formula = ~ Healthy_or_Diseased, 
                             phi.formula = ~ 1,
                             formula_null = ~ 1,
                             phi.formula_null = ~ 1,
                             test = "Wald", boot = FALSE,
...
DA.seawater.epidemic_nodate$significant_taxa
length(DA.seawater.epidemic_nodate$significant_taxa) #116! 
#   [1] "ASV1"    "ASV2"    "ASV3"    "ASV4"    "ASV5"    "ASV6"    "ASV7"    "ASV8"    "ASV9"    "ASV13"   "ASV14"   "ASV18"   "ASV19"   "ASV23"   "ASV25"   "ASV26"  
#  [17] "ASV27"   "ASV28"   "ASV31"   "ASV32"   "ASV33"   "ASV35"   "ASV36"   "ASV39"   "ASV40"   "ASV44"   "ASV45"   "ASV46"   "ASV49"   "ASV53"   "ASV57"   "ASV62"  
#  [33] "ASV64"   "ASV65"   "ASV71"   "ASV72"   "ASV73"   "ASV76"   "ASV79"   "ASV80"   "ASV81"   "ASV82"   "ASV83"   "ASV85"   "ASV88"   "ASV90"   "ASV93"   "ASV95"  
#  [49] "ASV96"   "ASV101"  "ASV108"  "ASV112"  "ASV113"  "ASV114"  "ASV115"  "ASV116"  "ASV126"  "ASV129"  "ASV144"  "ASV148"  "ASV149"  "ASV150"  "ASV154"  "ASV157" 
#  [65] "ASV159"  "ASV161"  "ASV162"  "ASV163"  "ASV168"  "ASV169"  "ASV172"  "ASV175"  "ASV176"  "ASV179"  "ASV180"  "ASV184"  "ASV188"  "ASV190"  "ASV194"  "ASV204" 
#  [81] "ASV207"  "ASV212"  "ASV218"  "ASV225"  "ASV228"  "ASV231"  "ASV236"  "ASV237"  "ASV249"  "ASV252"  "ASV260"  "ASV261"  "ASV262"  "ASV266"  "ASV275"  "ASV295" 
#  [97] "ASV307"  "ASV324"  "ASV325"  "ASV328"  "ASV339"  "ASV362"  "ASV397"  "ASV413"  "ASV418"  "ASV449"  "ASV505"  "ASV541"  "ASV598"  "ASV692"  "ASV840"  "ASV902" 
# [113] "ASV917"  "ASV1119" "ASV1126" "ASV1227"
plot(DA.seawater.epidemic_nodate)
```
