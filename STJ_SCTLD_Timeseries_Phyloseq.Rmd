...
ps.SW.Fishbay_Top200ASVs <- phyloseq::prune_taxa(Top200_ASVs, ps.SW.Fishbay.HorD) #new phyloseq object with 200 top taxa across samples from healthy or diseased samples
```
