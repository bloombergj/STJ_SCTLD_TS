...
setwd("~/Documents/WHOI/Projects/STJ_SCTLD_TimeseriesExperiment/Analysis_Code")
```
...
```{r}
#Upload data
load("~/Documents/WHOI/Projects/STJ_SCTLD_TimeseriesExperiment/Analysis_Code/otus_STJSCTLD_final.RData")
