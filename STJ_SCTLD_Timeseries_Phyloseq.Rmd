...
plot_grid(plot2A + theme_classic2() + theme(legend.position = "none"), 
          plot2B + theme_classic() + theme(legend.position = "none"), 
          plot2C + theme_classic() + theme(legend.position = "none"), 
          plot2D + theme_classic() + theme(legend.position = "none"), 
          legend_2health, 
          legend_2Date, 
          ncol = 2, nrow = 3)
...
ggplot()+
  geom_point(data=prev_fishbay, aes(x = Date_nice, y=Prev_Percent), na.rm = TRUE, color="Red") +
  geom_smooth(data=prev_fishbay, aes(x = Date_nice, y=Prev_Percent), na.rm = TRUE, method = loess, color="Red", se = FALSE) +
  scale_y_continuous(name = "SCTLD Prevelance (percent)") +
  xlab("Date") +
  theme(text=element_text(size=13))+
  ggtitle("SCTLD Prevelance in Fish Bay") 


prev_coralbay <- subset(Prevelance_ForAnalyses, Site == "Coral_Bay")
ggplot()+
  geom_point(data=prev_coralbay, aes(x = Date_nice, y=Prev_Percent), na.rm = TRUE, color="Red") +
  geom_smooth(data=prev_coralbay, aes(x = Date_nice, y=Prev_Percent), na.rm = TRUE, method = loess, color="Red", se = FALSE) +
  scale_y_continuous(name = "SCTLD Prevelance (percent)") +
  xlab("Date") +
  theme(text=element_text(size=13))+
  ggtitle("SCTLD Prevelance in Coral Bay") 
...
##################################################
##################################################
#significance testing for beta diversity in the different disease phases. I want to test sig dif for HDR in epidemic phases, then again for the endemic phase. 
